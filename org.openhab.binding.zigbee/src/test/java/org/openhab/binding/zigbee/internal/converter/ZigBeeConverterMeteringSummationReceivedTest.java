 ...
 *
 */
public class ZigBeeConverterMeteringSummationReceivedTest {
    ...
    public void testAttributeUpdated() {
        ...
        ZigBeeConverterMeteringSummationReceived converter = new ZigBeeConverterMeteringSummationReceived();
