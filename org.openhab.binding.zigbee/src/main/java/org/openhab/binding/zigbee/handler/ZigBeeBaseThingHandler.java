 ...
 */
public abstract class ZigBeeBaseThingHandler extends BaseThingHandler
        implements ZigBeeNetworkNodeListener, ZigBeeAnnounceListener, FirmwareUpdateHandler, ConfigDescriptionProvider,
        DynamicStateDescriptionProvider, ZigBeeOtaStatusCallback {
    /**
     * Our logger
     */
    ...
    protected synchronized void finalizeNodeInitialisation(ZigBeeNode node) {
